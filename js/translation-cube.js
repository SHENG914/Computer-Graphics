...
window.onload = function initCube() {
    ...
    document.getElementById("dx-plusbutton").onclick = function () {
        distance[xAxis] += 0.05;
    }

    document.getElementById("dy-plusbutton").onclick = function () {
		distance[yAxis] += 0.05;
    }

    document.getElementById("dz-plusbutton").onclick = function () {
        distance[zAxis] += 0.05;
	}
	document.getElementById("dx-minusbutton").onclick = function () {
        distance[xAxis] -= 0.05;
    }

    document.getElementById("dy-minusbutton").onclick = function () {
		distance[yAxis] -= 0.05;
    }

    document.getElementById("dz-minusbutton").onclick = function () {
        distance[zAxis] -= 0.05;
    }
