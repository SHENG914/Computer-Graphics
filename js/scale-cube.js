...
window.onload = function initCube() {
    ...
    document.getElementById("sx-plusbutton").onclick = function () {
        volume[xAxis] += 0.03;
    }

    document.getElementById("sy-plusbutton").onclick = function () {
		volume[yAxis] += 0.03;
    }

    document.getElementById("sz-plusbutton").onclick = function () {
        volume[zAxis] += 0.03;
	}
	document.getElementById("sx-minusbutton").onclick = function () {
        volume[xAxis] -= 0.03;
    }

    document.getElementById("sy-minusbutton").onclick = function () {
		volume[yAxis] -= 0.03;
    }

    document.getElementById("sz-minusbutton").onclick = function () {
        volume[zAxis] -= 0.03;
    }
